/* [project]/node_modules/@digdir/designsystemet-css/dist/src/index.css [app-client] (css) */
@layer ds.base {
  .ds-sr-only {
    clip: rect(0 0 0 0);
    white-space: nowrap;
  ...
  @supports (width: round(down,.1em,1px)) {
    :root {
      --ds-font-size-minus-1: round(down, max(.9em, .875rem), .0625rem);
      --ds-font-size-plus-1: round(down, 1.1em, .0625rem);
    }
  }
  ...
  .ds-validation-message {
    ...
    -webkit-padding-start: calc(var(--dsc-validation-message-icon-size)  + var(--dsc-validation-message-spacing));
    margin: 0;
...
@layer ds.components {
  .ds-link {
    ...
    --dsc-link-text-decoration-thickness--hover: .125em;
    --dsc-link-text-decoration-thickness: .0625em;
  ...
  .ds-input[aria-invalid="true"]:where(:checked), .ds-input[type="checkbox"][aria-invalid="true"]:where(:indeterminate) {
  ...
  .ds-input[type="radio"]:checked {
    background-image: radial-gradient(circle closest-side, currentColor 45%, #0000 50%);
  }
  ...
  .ds-input[role="switch"]:is([type="radio"], [type="checkbox"]) {
    ...
    background-image: radial-gradient(circle closest-side, currentColor 95%, #0000 100%);
    background-origin: content-box;
  ...
  .ds-fieldset > * + * {
    -webkit-margin-before: var(--ds-size-4);
  ...
  .ds-alert {
    ...
    -webkit-padding-end: var(--dsc-alert-padding-inline-end);
    -webkit-padding-start: calc(var(--dsc-alert-padding-inline-end)  + var(--dsc-alert-icon-size)  + var(--dsc-alert-spacing));
  ...
  .ds-search:not(:has(button:not([type="reset"]))) input {
    -webkit-padding-start: calc(var(--dsc-search-magnifying-icon-size)  + var(--dsc-search-padding-inline) * 2);
  ...
  .ds-search:has(input:placeholder-shown) button[type="reset"] {
    display: none;
  }

  .ds-search:has(input:is(:read-only, :disabled, [aria-disabled="true"])) button[type="reset"], .ds-search:has(input:is(:read-only, :disabled, [aria-disabled="true"])) button[type="reset"], .ds-search:has(input:placeholder-shown) button[type="reset"] {
    display: none;
  }

  .ds-search:has(button[type="reset"]) input {
    -webkit-padding-end: calc(var(--dsc-search-clear-size)  + var(--dsc-search-padding-inline));
  ...
  .ds-dialog {
    --dsc-dialog-backdrop-background: #00000080;
  ...
  .ds-dialog::backdrop {
    background: var(--dsc-dialog-backdrop-background, #00000080);
    animation: .3s ease-in-out fade-in;
  }

  .ds-dialog[open] {
    animation: .3s ease-in-out slide-in, .3s ease-in-out fade-in;
  }
  ...
  .ds-dialog > form[method="dialog"]:first-child > button:only-child {
    color: inherit;
    float: right;
    margin: var(--_dsc-dialog-icon-top-right-margin) var(--_dsc-dialog-icon-top-right-margin) var(--dsc-dialog-icon-spacing) var(--dsc-dialog-icon-spacing);
  }
  ...
  .ds-card :is(h1, h2, h3, h4, h5, h6) a:-moz-any-link, .ds-card:is(a:-moz-any-link, button, [role="button"]) :is(h1, h2, h3, h4, h5, h6) {
    ...
    outline: 0;
    text-decoration: underline max(1px, .0625rem, .1025em);
  }
  ...
  .ds-chip[data-removable] {
    -webkit-padding-end: var(--dsc-chip-spacing);
  ...
  .ds-chip:has(input[type="radio"]) {
    -webkit-padding-start: var(--dsc-chip-spacing);
  ...
  .ds-skeleton {
    --dsc-skeleton-animation-duration: .8s;
  ...
  .ds-tooltip {
    ...
    --dsc-tooltip-transition-duration: .2s;
    --dsc-tooltip-transition-delay: .15s;
  ...
  :is(.ds-table > :is(tbody, thead, tfoot) > tr > :is(th, td)):is(th) {
    font-weight: 500;
  }
  ...
  @media (width >= 650px) {
    .ds-breadcrumbs > :not(ol, ul):not(:only-child) {
      display: none;
    }
  }
  ...
  :is(.ds-suggestion u-datalist) > :is(u-option) {
    border-radius: var(--ds-border-radius-sm);
    cursor: pointer;
    -webkit-padding-start: var(--dsc-suggestion-option-checkmark-size);
    border: none;
  ...
  .ds-suggestion:has(input:placeholder-shown) button[type="reset"] {
    visibility: hidden;
  }

  .ds-suggestion:has(input:is(:read-only, :disabled, [aria-disabled="true"])) button[type="reset"], .ds-suggestion:has(input:is(:read-only, :disabled, [aria-disabled="true"])) button[type="reset"], .ds-suggestion:has(input:placeholder-shown) button[type="reset"] {
    visibility: hidden;
  }

  .ds-suggestion:has(button[type="reset"]) input {
    -webkit-padding-end: calc(var(--dsc-suggestion-clear-size)  + var(--dsc-suggestion-clear-gap));
  ...
  .ds-suggestion button[type="reset"] {
    ...
    -webkit-margin-start: calc((var(--dsc-suggestion-clear-size)  + var(--dsc-suggestion-clear-gap)) * -1);
  ...
  :is(.ds-multi-suggestion u-datalist) > :is(u-option) {
    border-radius: var(--ds-border-radius-sm);
    cursor: pointer;
    -webkit-padding-start: var(--dsc-multi-select-option-checkmark-size);
    border: none;
    border-left: 5px solid #0000;
    outline: none;
  ...
  .ds-multi-suggestion:has(input:placeholder-shown) button[type="reset"] {
    visibility: hidden;
  }

  .ds-multi-suggestion:has(input:is(:read-only, :disabled, [aria-disabled="true"])) button[type="reset"], .ds-multi-suggestion:has(input:is(:read-only, :disabled, [aria-disabled="true"])) button[type="reset"], .ds-multi-suggestion:has(input:placeholder-shown) button[type="reset"] {
    visibility: hidden;
  }

  .ds-multi-suggestion:has(button[type="reset"]) input {
    -webkit-padding-end: calc(var(--dsc-multi-select-clear-size)  + var(--dsc-multi-select-clear-gap));
  ...
  .ds-multi-suggestion button[type="reset"] {
    ...
    -webkit-margin-start: calc((var(--dsc-multi-select-clear-size)  + var(--dsc-multi-select-clear-gap)) * -1);
...
/*# sourceMappingURL=node_modules_%40digdir_designsystemet-css_dist_src_index_css_f9ee138c._.single.css.map*/